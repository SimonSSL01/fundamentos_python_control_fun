"""Una característica poderosa de Python es la 
capacidad de devolver múltiples valores 
desde una función:"""
...
"""Técnicamente, Python empaqueta estos valores 
en una tupla que luego podemos desempaquetar 
en variables individuales. 
También podemos capturar el resultado 
