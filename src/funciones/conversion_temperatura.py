...
El uso efectivo de `return` es fundamental para crear funciones que no solo realicen tareas,
 sino que también proporcionen resultados útiles que podamos utilizar en otras partes de nuestro programa."""